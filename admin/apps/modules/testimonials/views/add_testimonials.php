                                ...
                                <div class="row">   
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter Designation" name="profile" required/>
                                        </div> 
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group"> 
                                            ...
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter Location" name="location" required/>
                                        </div> 
                                    ...
                                    <div class="col-sm-12"> 
                                        <div class="form-group"> 
                                            ...
                                            <textarea  name="desc" class="form-control form-control-sm"  required></textarea>
                                        </div>
                                    </div> 
