                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                           ...
                           <div class="form-group"> 
                              ...
                              <label class="col-form-label">https://jobdine.com/engine/categorie/ <input type="text" name="name_slug" id="name_slug" class="form-control form-control-url form-control-sm" value="<?=$cate_info->name_slug;?>"placeholder="Url" /></label> 
                        ...
                        <div class="col-sm-6">
                           ...
                           <img src="<?=base_url('uploads/category/').$cate_info->img;?>" width="auto" height="60px" style="border: 1px solid #a1a1a1;">
