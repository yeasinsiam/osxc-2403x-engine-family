                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="report-table"
                                   class="table table-sm table-bordered table-striped mb-0 dataTable no-footer">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Img</th>
                                    ...
                                    foreach ($news as $value) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php if (!empty($value->img)) { ?>
                                                    <img src="<?= base_url('uploads/news/') . $value->img; ?>"
                                                         style="width: 80px; height: 60px;object-fit: cover;"/>
                                                <?php } else { ?>
                                                    <img src="<?= base_url('uploads/category/default-image.jpg'); ?>"
                                                         style="width: 80px; height: 60px;object-fit: cover;"/>
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('news/edit/') . $value->id; ?>"
                                                   class="btn btn-info" title="Edit"><i
                                                            class="feather icon-edit"></i></a>
                                                <a href="<?= base_url('news/delete/') . $value->id; ?>"
