                         ...
                         <?php }?>
                                            ...
                                            <td>  
                                               <!--  <a href="#" class="btn btn-success" title="View"><i class="feather icon-eye"></i></a> -->
                                                <a href="<?=base_url('product/edit/').$value->id;?>" class="btn btn-info" title="Edit"><i class="feather icon-edit"></i></a>  
                                                <a href="<?=base_url('product/delete/').$value->id;?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this product ?');">
