            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-info" href="add_cate"> Add Category</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=base_url('news/edit_cate/').$value->id;?>" class="btn btn-info" title="Edit"><i class="feather icon-edit"></i></a>
                                            <a href="<?=base_url('news/delete_cate/').$value->id;?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this category?');">
