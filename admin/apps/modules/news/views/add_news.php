                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label">https://engine-family.com/news_detail/ <input type="text" name="name_slug" id="name_slug" class="form-control form-control-url form-control-sm" placeholder="Url" /></label>
