                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           ...
                           <div class="form-group">  
                              ...
                              <label class="col-form-label">https://jobdine.com/engine/part_categories/ <input type="text" name="name_slug" id="name_slug" class="form-control form-control-url form-control-sm" placeholder="Url" /></label>
                           </div>
                           <div class="form-group">
