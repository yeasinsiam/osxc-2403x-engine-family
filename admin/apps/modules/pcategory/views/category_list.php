                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($value->type=='0'){
                                            echo'-';}else{ echo pcategory($value->type);}?></td>
                                        <!-- <td class="text-wrap"><?=$value->desc;?></td>   -->
                                        <td>
                                              <a href="<?=base_url('../part/').$value->name_slug;?>" class="btn btn-success" title="View"><i class="feather icon-eye"></i></a>
                                            <a href="<?=base_url('pcategory/edit/').$value->id;?>" class="btn btn-info" title="Edit"><i class="feather icon-edit"></i></a>
                                            <a href="<?=base_url('pcategory/delete/').$value->id;?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this category?');">
