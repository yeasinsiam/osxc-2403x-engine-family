                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <label class="col-form-label">https://jobdine.com/engine/product/ <input type="text" name="name_slug" id="name_slug" class="form-control form-control-url form-control-sm" value="<?=$product_info->name_slug;?>"placeholder="Url" /></label> 
