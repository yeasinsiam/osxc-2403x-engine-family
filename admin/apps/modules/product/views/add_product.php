                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label">https://engine-family.com/product/ <input type="text" name="name_slug" id="name_slug" class="form-control form-control-url form-control-sm" placeholder="Url" /></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group custom-control custom-checkbox ">
                                        <input type="checkbox"   class="custom-control-input" name="products" id="customradio1" value="1">
