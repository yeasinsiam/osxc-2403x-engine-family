                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-form-label">https://engine-family.com/product/ <input type="text" name="name_slug" id="name_slug" class="form-control form-control-url form-control-sm" value="<?=$product_info->name_slug;?>"placeholder="Url" /></label>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php if(!empty($product_info->img)){?>
                                        ...
                                        <img src="<?=base_url('uploads/product/').$product_info->img;?>" width="auto" height="60px" style="border: 1px solid #a1a1a1;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group custom-control custom-checkbox ">
                                    <input type="checkbox"   class="custom-control-input" name="products" id="customradio1" value="1" <?php  if($product_info->products=='1')echo'checked';?> >
                                    <label  class="custom-control-label bold" for="customradio1">show Products</label>
                                    </div>
                                </div>
                                <div class="col-sm-4">
