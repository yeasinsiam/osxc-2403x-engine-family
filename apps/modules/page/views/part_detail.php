                ...
                <div class="col-lg-6">
                    ...
                    <div class="prdt-image bg-light-white p-4" style="margin: 0 auto;">
                        ...
                        <?php }else{?>
                             ...
                             <img src="<?=base_url('admin/uploads/product/Defaults-image.jpg');?>" alt="<?=$product->img_tag;?>" style="margin: 0 auto;" />
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <div class="custom-select">
                                    ...
                                    <div class="custom-options">
                                        ...
                                        <a class="custom-option" href="<?=base_url('part-product/').$val->name_slug;?>" ><?=$val->name;?></a>
