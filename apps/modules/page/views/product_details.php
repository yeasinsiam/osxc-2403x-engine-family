...
<head>
    ...
    <section class="section prdt-detail">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="prdt-image bg-light-white p-4" style="margin: 0 auto; text-align:center">
                        <a href="#">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="prdt-info-right pl-0 pl-md-00 mt-md-25">
                        <div class="prdt-detail-head mt-10 clearfix">
                            ...
                            <h1 class="mt-0 mb-0 fs-26 lh-13 blue" style="display: inline-block;"><?= $product->name; ?>
                            </h1>
                                            ...
                                            <div class="custom-options">
                                                ...
                                                <?php foreach ($product_list as $val) { ?>
                                                    <a class="custom-option"
                                                        href="<?= base_url('product/') . $val->name_slug; ?>"><?= $val->name; ?></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="prdt-form">
                            ...
                            <button type="button" class="btn btn-blue" data-toggle="modal" data-target="#enquiry-now"><i
    ...
    <div class="modal fade" id="enquiry-now" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form class="form-horizontal custom-form" action="<?= base_url('page/sent'); ?>" method="post" role="form">
                ...
                <input type="hidden" id="current_url" name="product_url"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success"><i class="fas fa-comments"></i> Enquiry
                            Now</button>
                    </div>
                </div>
            </form>
