            ...
            <div class="row rewoww">
                ...
                <?php if ($category == true) { ?>
                    ...
                    <div class="col-lg-12 text-center">
                        ...
                        <h3 class="fs-34 mb-45 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                            <?= $product->title; ?></h3>
                        ...
                        <div class="pager-nav">
                            ...
                            <nav class="pager" role="navigation" aria-labelledby="pagination-heading--2">
                                ...
                                <ul class="pager__items js-pager__items">
                                    ...
                                    <li class="pager__item pager__item--first" <?php if ($now_page == 1) { ?>
                                        style="display: none" <?php } ?>>

                                        <a href="javascript:;" data-page="1" class="page-btn"
                                    ...
                                    <li class="pager__item pager__item--previous" <?php if ($now_page == 1) { ?>
                                        style="display: none" <?php } ?>>

                                        <a href="javascript:;" data-page="<?= $now_page - 1 ?>" class="page-btn"
                                    ...
                                    <?php for ($ik = 1; $ik <= $page_total_page; $ik++) { ?>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <li class="pager__item">
                                                ...
                                                <a href="javascript:;" data-page="<?= $ik ?>" title="Go to page " class="page-btn">
                                    ...
                                    <li class="pager__item pager__item--next" <?php if ($ik != $now_page) { ?>
                                        style="display:none" <?php } ?>>

                                        <a href="javascript:;" class="page-btn" data-page="<?= ($now_page + 1); ?>"
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        for (const p in pro_list) {
                            ...
                            img = pvalue['img'] ? '/admin/uploads/product/' + pvalue['img'] :
                                '/admin/uploads/product/Defaults-image.jpg';

                            html_ +=
                                '<div class="col-lg-3 col-md-4"> <div class="shop-prdt mb-30 wow fadeInLeft">' +
                                ...
                                '<h5 class="f-700 fs-16 lh-13">' + pvalue["name"] +
                                '</h5></a></div><div class="shop-prdt-img">' +

                                '<a href="<?= base_url('part-product/') ?>' + pvalue["name_slug"] +
                                '">' +

                                '<img src="' + img + '" alt="' + pvalue['img_tag'] +
                                '" class="bg-white"/>' +

                                '</a> </div><div class="shop-prdt-data text-pvalue">' + pvalue[
                                    'short_desc'] +
