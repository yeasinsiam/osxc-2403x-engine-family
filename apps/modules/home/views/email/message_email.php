...
<head>
  ...
  <title>Welcome to <?php echo $this->website->web_company_name;?></title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;background-color: #fed149; height: 100%; margin: 0; padding: 0; width: 100%">
 ...
 100%; background-color: #f6f6f6;border-color: grey; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #111;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="<?php echo base_url();?>" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="<?php echo $this->website->web_company_name;?>"><img src="https://dentalarchive.net/admin/uploads/website/logo/Dentalarchive_logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 35%; margin: 0px;" />
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="<?php echo base_url();?>" style="mso-line-height-rule:
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%;" width="100%">
                  <tbody class="mcnTextBlockOuter">
                    <tr>
                      <td class="mcnTextBlockInner" style="mso-line-height-rule: exactly;background-color:#fff;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%" valign="top">
                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
 mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust:
 100%; min-width:100%;" width="100%">
 ...
 sans-serif; font-size: 24px; font-style: normal; line-height:
 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0;
 padding: 0'><span >You have new message</span></h2>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="mcnTextBlock" style="border-collapse: collapse;background-color:#fff; mso-table-lspace: 0; mso-table-rspace:
 ...
 100%; min-width:100%;" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonBlock" style="border-collapse: collapse;background-color:#fff; mso-table-lspace: 0;
 mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 min-width:100%;" width="100%">
 ...
 padding-top:0px; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top">
 ...
 padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top">
                <p style="padding: 12px;font-size:22px"><b><?php echo $sender['name'];?></b></p>
                                <p style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #2a2a2a; font-family: 'Asap', Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px;
 padding-bottom: 9px; text-align: center;"><?php echo $sender['msg'];?></p>

    <p style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #2a2a2a; font-family: 'Asap', Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px;
 padding-bottom: 9px; text-align: justify;"><center><a href="<?php echo $sender['url'];?>" style=" background: #111;color:#fff;padding: 20px;">View Message</a></center></p>
                         
 <p style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #2a2a2a; font-family: 'Asap', Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; 
 padding-bottom: 9px;  text-align: justify;">If you have any questions, please visit our Contact Page or write us to <a href="mailto:<?php echo $this->website->web_support_email;?>"><?php echo $this->website->web_support_email;?></a></p>
 <p style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #2a2a2a; font-family: 'Asap', Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; 
 padding-bottom: 9px; text-align: justify;">Thanks,<br>
Team <?php echo $this->website->web_company_name?>.</p>
                              </td>
                            </tr>
                          </tbody>
                        </table>
 ...
 border-top: 0; border-bottom: 0; padding-top: 8px;" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnTextBlock" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%;" width="100%">
                  <tbody class="mcnTextBlockOuter">
                    <tr>
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                <div style="text-align: center;">Powered By
                                  <a href="<?php echo base_url();?>" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="<?php echo $this->website->web_company_name?>"><?php echo $this->website->web_company_name?></a> in <?php echo $this->website->web_address?></div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
